    ...
    public static class GameCatalog
    {
        ...
        public static List<GameProfile> All { get; } = new()
        {
            new GameProfile
            {
                ...
                BannerImagePath = "avares://VietHoaInstaller.Avalonia/Assets/PlagueIncVH.jpg",
                SteamAppId = "246620",
                GitHubOwner = "Ryo147",
                GitHubRepo = "PatchVH",
                GitHubReleaseTag = "1",
            ...
            new GameProfile
            {
                ...
                BannerImagePath = "avares://VietHoaInstaller.Avalonia/Assets/RE2_DX11.png", // TODO: đảm bảo file này nằm trong thư mục Assets
                SteamAppId = "883710",
